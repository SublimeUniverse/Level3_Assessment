...
class Statistics:
    def __init__(self, questions_correct, questions_answered):
        self.play_box = Toplevel()
        self.start_frame = Frame(self.play_box, bg="#DAE8FC")
        self.start_frame.grid(padx=10, pady=10)

        # questions actually answered is questions_answered - 1
        questions_finished = questions_answered - 1

        stats_labels_list = [
            [" Statistics ", ("Arial", "15", "bold"), "#000000", "#87CBE8"],
            [f"Questions Answered: {questions_finished}", ("Arial", "11", "bold"), None, "#DAE8FC"],
            [f"Correct: {questions_correct}", ("Arial", "11", "bold"), None, "#DAE8FC"],
            [f"Incorrect: {questions_finished - questions_correct}", ("Arial", "11", "bold"), None, "#DAE8FC"],
            ["Close: ", ("Arial", "11", "bold"), None, "#DAE8FC"],
...
class Play:
    def __init__(self, how_many, level):
        ...
        self.stats_button = Button(self.start_frame, font=("Arial", 15, "bold"),
                                   ...
                                   state=DISABLED, command=lambda: Statistics(self.questions_correct.get(),
                                                                              self.rounds_played.get())
                                   )
